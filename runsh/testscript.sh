...
echo TEST_RESOURCE_POINTER_FIELDNAME=$TEST_RESOURCE_POINTER_FIELDNAME
echo TEST_RESOURCE_SEED_FIELDNAME=$TEST_RESOURCE_SEED_FIELDNAME
...
set_context() {
  ...
  echo SAMPLE_SCRIPTREPOBBS_IS_FORK=$(eval echo "$"$TEST_RES_REPO_UP"_IS_FORK")
  echo SAMPLE_SCRIPTREPOBBS_IS_PULL_REQUEST=$(eval echo "$"$TEST_RES_REPO_UP"_IS_PULL_REQUEST")
  echo SAMPLE_SCRIPTREPOBBS_REPO_FULL_NAME=$(eval echo "$"$TEST_RES_REPO_UP"_REPO_FULL_NAME")
  echo SAMPLE_SCRIPTREPOBBS_PULL_REQUEST_REPO_FULL_NAME=$(eval echo "$"$TEST_RES_REPO_UP"_PULL_REQUEST_REPO_FULL_NAME)
}
