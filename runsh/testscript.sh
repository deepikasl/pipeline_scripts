...
echo 'from pr1 to pr pull request in same repo'
...
set_context() {
  ...
  export TEST_REPO_REPO_FULL_NAME=$(eval echo "$"$TEST_RES_REPO_UP"_REPO_FULL_NAME")
  ...
  echo TEST_REPO_REPO_FULL_NAME=$TEST_REPO_REPO_FULL_NAME
