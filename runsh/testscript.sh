...
export TEST_JOBNAME_NAME=$(eval echo "$"$TEST_CURR_JOB"_NAME")
export TEST_JOBNAME_TYPE=$(eval echo "$"$TEST_CURR_JOB"_TYPE")
export TEST_JOBNAME_PATH=$(eval echo "$"$TEST_CURR_JOB"_PATH")
export TEST_JOBNAME_PREVIOUS_STATE=$(eval echo "$"TEST_CURR_JOB"_PREVIOUS_STATE")
export TEST_JOBNAME_STATE=$(eval echo "$"$TEST_CURR_JOB"_STATE")
export TEST_JOBNAME_MESSAGE=$(eval echo "$"$TEST_CURR_JOB"_MESSAGE")
...
echo TEST_JOBNAME_NAME=$JOBNAME_NAME
echo TEST_JOBNAME_TYPE=$JOBNAME_TYPE
echo TEST_JOBNAME_PATH=$JOBNAME_PATH
echo TEST_JOBNAME_STATE=$JOBNAME_STATE
echo TEST_JOBNAME_PREVIOUS_STATE=$JOBNAME_PREVIOUS_STATE
echo TEST_JOBNAME_MESSAGE=$JOBNAME_MESSAGE
...
echo TEST_RESOURCE_INTEGRATION_FIELDNAME=$TEST_RESOURCE_INTEGRATION_FIELDNAME
